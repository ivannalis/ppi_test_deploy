...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 18, 2021 at 10:53 PM
...
(10, 2, 'Proteksi', 'Luas dan laju deforestasi dan degradasi menurun', 'Deforestasi', 8780, 0, 'hektar/tahun', 20, '+', '2021-04-01'),
(11, 2, 'Proteksi', 'Luas dan laju deforestasi dan degradasi menurun', 'Degradasi', 20, 0, 'hektar/tahun', 0, '+', '...'),
(12, 3, 'Proteksi', 'Emisi karbon menurun', 'Emisi deforestasi', 2770668, 0, 'tonCO2eq/tahun', 0, '+', '...'),
(13, 3, 'Proteksi', 'Emisi karbon menurun', 'Emisi degradasi', 3347, 0, 'tonCO2eq/tahun', 0, '', '...'),
...
(55, 'Tutupan Lahan tahun 2019', NULL, 86, 'd', 'public/assets/geojson/1618606393319-1616240324922-admin_new.geojson', 'Rest Service KLHK tahun 2019', 1, '2021-04-01 11:17', 'point', 'default'),
...
(254, 'Kuala Mandor B', '#000000', '55', '', 'WADMKC'),
...
(7, 'Proteksi', 9, 2, '', 20, 'hektar', '2021-04-19');
...
--
ALTER TABLE `shp`
  MODIFY `id_shp` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;

--
-- AUTO_INCREMENT for table `styleshp`
--
ALTER TABLE `styleshp`
  MODIFY `id_style` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=315;

--
-- AUTO_INCREMENT for table `update_indikator_ppi`
--
ALTER TABLE `update_indikator_ppi`
  MODIFY `id_update_indikator_ppi` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
