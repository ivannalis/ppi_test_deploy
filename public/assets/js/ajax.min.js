    ...
    1: [
        function (e, t, n) {
            ...
            a.prototype.then = function (e, t) {
                if ("function" != typeof e && this.state === m || "function" != typeof t && this.state === y) 
                    return this;
        ...
        function (e, t, n) {
            (function (e) {
                ...
                if (o) {
                    ...
                    a = "document" in e && "onreadystatechange" in e
                        .document
                ...
                t.exports = function (e, t) {
                    ...
                    var o,
                        ...
                        s = new a(function (r, a) {
                            i = a,
                            void 0 === n.XMLHttpRequest && a("XMLHttpRequest is not supported");
                            var s;
                ...
                n.GeoJSON.AJAX = n
                    ...
                    .extend({
                        ...
                        initialize: function (e, t) {
                            ...
                            var a = n
                                .Util
                                .extend({}, this.defaultAJAXparams);
                            for (var o in t) 
                                this
                                    .defaultAJAXparams
                                    .hasOwnProperty(o) && (a[o] = t[o]);
                            this.ajaxParams = a,
                            this._layers = {},
                            n
                                .Util
                            ...
                            t
                                ...
                                .forEach(function (e) {
                                    "json" === t
                                        ...
                                        .dataType
                                        .toLowerCase()
                                            ? a(e, t.ajaxParams).then(function (e) {
                                                var n = t
                                                    .ajaxParams
                                                    .middleware(e);
                                                t.addData(n),
                                                t.fire("data:progress", n)
                                            }, function (e) {
                        ...
                        refilter: function (e) {
                            "function" != typeof e
                                ? (this.filter = !1, this.eachLayer(function (e) {
                                    e.setStyle({
                                        stroke: !0,
                                        clickable: !0
                                    })
                    ...
                    var o,
                        ...
                        f = new a(function (r, a) {
                            ...
                            t.callbackName
                                ...
                                : (s = "_" + (
                                    "" + Math.random()
                                ).slice(2), o = "_leafletJSONPcallbacks." + s),
                            c.type = "text/javascript",
                            s && (
                                n._leafletJSONPcallbacks || (n._leafletJSONPcallbacks = {
                                    length: 0
                                }),
                                ...
                                n._leafletJSONPcallbacks[s] = function (e) {
                                    ...
                                    n._leafletJSONPcallbacks.length--,
                                    n._leafletJSONPcallbacks.length || delete n._leafletJSONPcallbacks,
                                    r(e)
                                }
                            ),
                            i = -1 === e.indexOf("?")
